...
public class FeedFilterChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    private FeedFilterChatActivityDelegate delegate;
    ...
    public interface FeedFilterChatActivityDelegate {
        void didSelectChats(ArrayList<Long> ids);
    }
            ...
            if (!animationStarted) {
                ...
                if (currentAnimation != null) {
                    ...
                    if (containerHeight != resultHeight) {
                        animators.add(ObjectAnimator.ofInt(FeedFilterChatActivity.this, "containerHeight", resultHeight));
                    }
    ...
    public FeedFilterChatActivity(ArrayList<Long> arrayList) {
        super();
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle("Include Channels");
        ...
        editText.setHintText("Search for channels");
        ...
        listView.setOnItemClickListener((view, position) -> {
            if (view instanceof GroupCreateUserCell) {
                ...
                if (exists = selectedContacts.indexOfKey(id) >= 0) {
                    ...
                    span.setOnClickListener(FeedFilterChatActivity.this);
                }
                updateHint();
    ...
    private boolean onDonePressed(boolean alert) {
        ...
        if (delegate != null) {
            delegate.didSelectChats(result);
        }
        finishFragment();
        return true;
    }
    ...
    private void closeSearch() {
        ...
        listView.setVerticalScrollBarEnabled(false);
        emptyView.setText("No Chats");
    }
    public static final int MAX_SELECT = 10;

    private void updateHint() {
        if (selectedCount == 0) {
            actionBar.setSubtitle(LocaleController.formatString("MembersCountZero", R.string.MembersCountZero, LocaleController.formatPluralString("Chats", MAX_SELECT)));
        } else {
            actionBar.setSubtitle(String.format(LocaleController.getPluralString("MembersCountSelected", selectedCount), selectedCount, MAX_SELECT));
        }
    }

    public void setDelegate(FeedFilterChatActivityDelegate feedFilterChatActivityDelegate) {
        delegate = feedFilterChatActivityDelegate;
    }
            ...
            switch (holder.getItemViewType()) {
                case 1: {
                    ...
                    if (searching) {
                        ...
                        object = contacts.get(position - 1);
                    }
                    long id;
                    if (object instanceof TLRPC.Chat) {
                        id = -((TLRPC.Chat) object).id;
        ...
        public void searchDialogs(final String query) {
            ...
            if (query == null) {
                ...
                Utilities.searchQueue.postRunnable(searchRunnable = () -> AndroidUtilities.runOnUIThread(() -> {
                    searchAdapterHelper.queryServerSearch(query, true, true, false, false, false, 0, false, 0, 0);

...
import org.master.feature.feed.FeedFilter;
import org.master.feature.feed.FeedManager;
...
public class FeedFilterTabsView extends FrameLayout {
    ...
    public class TabView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (textLayout != null && OwlConfig.tabMode != 0) {
                ...
                Drawable icon_active = getResources().getDrawable(FolderIconHelper.getTabIcon(currentTab.emoticon));
                ...
                Drawable icon = getResources().getDrawable(FolderIconHelper.getTabIcon(currentTab.emoticon));
    ...
    private final Property<FeedFilterTabsView, Float> COLORS = new AnimationProperties.FloatProperty<FeedFilterTabsView>("animationValue") {
        @Override
        public void setValue(FeedFilterTabsView object, float value) {
        ...
        @Override
        public Float get(FeedFilterTabsView object) {
            return animationValue;
        }
    };

    public FeedFilterTabsView(Context context) {
        super(context);
        ...
        listView = new RecyclerListView(context) {
            ...
            public void setAlpha(float alpha) {
                ...
                FeedFilterTabsView.this.invalidate();
            }

            @Override
            protected boolean allowSelectChildAtPosition(View child) {
                return FeedFilterTabsView.this.isEnabled() && delegate.canPerformActions();
            }
    ...
    public void setIsEditing(boolean value) {
        ...
        if (!isEditing && orderChanged) {
            FeedManager.getInstance(UserConfig.selectedAccount).saveFeedFiltersOrder();
            orderChanged = false;
        }
    }
...
//            }
            ...
            ArrayList<FeedFilter> filters = FeedManager.getInstance(UserConfig.selectedAccount).feedFilters;

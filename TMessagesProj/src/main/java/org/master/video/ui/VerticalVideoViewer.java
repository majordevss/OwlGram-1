...
public class VerticalVideoViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private class FrameLayoutDrawer extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            VerticalVideoViewer.this.onDraw(canvas);
        }
    ...
    private static volatile VerticalVideoViewer Instance = null;
    public static VerticalVideoViewer getInstance() {
        VerticalVideoViewer localInstance = Instance;
        if (localInstance == null) {
            synchronized (VerticalVideoViewer.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new VerticalVideoViewer();
                }
            }
        }
